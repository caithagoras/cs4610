...
The release notes should be placed at the end of PR description. The format of the section will be:
...
If the pull request does not have a user-facing impact and thus a release note is not required. Place the following line at the end of the PR description:
